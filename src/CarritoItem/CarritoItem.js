      ...
      <div className="item item-neumorphism">
        ...
        <div className="main">
          <div className="title container-flex">
            <span className="title"> {item.name || "que tal"} </span>
          </div>

          {/* <div className="container-flex container-justify-center p-top p-bottom">
    <div className="divider"></div>
  </div>
*/}
          <div className="description">
            <span>{item.description || "hola"}</span>
          </div>

          <Select />
          <div className="collapsible" onClick={(e) => handleCollapsible(e)}>
            Open Sizes
          </div>
        ...
        <div className="footer container-flex container-justify-end"></div>
      </div>
    </>
  );
};
